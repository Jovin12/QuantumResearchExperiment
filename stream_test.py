...
from diff_pages import Home, QExperiment_EntryPage, QExperiment_Display, QExperiment_NoiseInjection, QExpeiment_CircuitCompressPerformance,QExperiment_showcase
...
if st.session_state.username == "":
    ...
    if st.session_state.page == "Home":
        Home.home_page()
    elif st.session_state.page == "Quantum Experiment Data Entry":
        QExperiment_EntryPage.entry_page()
    elif st.session_state.page == "Quantum Experiment Display":
        QExperiment_Display.display_page()
    elif st.session_state.page == "Noise Injection Experiment":
        QExperiment_NoiseInjection.noise_injection_page()
